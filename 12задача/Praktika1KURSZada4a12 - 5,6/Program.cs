...
namespace Praktika1KURSZada4a12___5_6
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            int treeCounterCompareStandart = 0;
            int treeCounterCompareIncrease = 0;
            int treeCounterCompareDecrease = 0;
            ...
            MyTimeHasCome.Start();
            TreeWork(standartArray, ref treeCounterCompareStandart);
            MyTimeHasCome.Stop();
            Console.WriteLine("==========================================================================================================");
            ...
            Console.WriteLine("Кол-во пересылок: 0");
            ...
            MyTimeHasCome.Start();
            TreeWork(increaseArray, ref treeCounterCompareIncrease);
            MyTimeHasCome.Stop();
            Console.WriteLine("==========================================================================================================");
            ...
            MyTimeHasCome.Start();
            TreeWork(decreaseArray, ref treeCounterCompareDecrease);
            MyTimeHasCome.Stop();
            Console.WriteLine("==========================================================================================================");
        ...
        /// <param name="changes"></param>
        /// <returns></returns>
        public static int[] TreeWork(int[] array, ref int compare)
        {
            int index = 0;
            ...
            {
                compare++;
                tree.AddRecurs(new TreeSort(array[i]), ref compare);
            }
            return tree.ToMas(ref compare, index, ref array);
        }
    }
